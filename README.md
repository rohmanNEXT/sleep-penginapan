...
- **Superadmin** mengupload maxsimal 3 cupon global hanya sekali pakai oleh user aja 
- **Admin** mengupload penginapan dengan data lengkap 
- **user@user.com** sebagai pembeli penginapan 
- Profile image default untuk setiap user 
